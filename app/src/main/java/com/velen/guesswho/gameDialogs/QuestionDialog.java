...
public class QuestionDialog {
    ...
    public QuestionDialog(SwitchableDialogDisplayer displayer, Player playerAsks) {
        this.displayer = displayer;
        this.playerWhoAnswers = playerAsks;
        this.groupLeader = playerAsks.getCurrentCharacterGroup().getGroupLeader();
    }
